...
class AmplifiedHighlands(
  ...
  // --- Large-scale shape ---
  private val continentAmp: Double = 140.0 * scale,   // big landmass up/down
  private val hillsAmp: Double = 38.0 * scale,        // mid bumps
  private val detailAmp: Double = 8.0 * scale,        // small roughness

  // --- Amplified peaks ---
  private val peakAmp: Double = 200.0 * scale,        // main “AMPLIFIED” height
  ...
  private fun amplifiedOffset(ctx: GenerateContext, x: Int, z: Int): Double {
    val wx = x.toDouble()
    val wz = z.toDouble()
